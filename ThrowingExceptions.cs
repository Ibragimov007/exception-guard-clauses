...
namespace ExceptionGuardClauses
{
    public static class ThrowingExceptions
    {
        ...
        public static string GenerateUserCode(string code, int day)
        {
            ...
            if (code.Length != 4)
            {
                throw new ArgumentNullException(nameof(code), $"has {code.Length} chars.");
            }
        ...
        public static string GenerateGreeting(string hello, string[] addressee, int index)
        {
            ...
            {
                throw new ArgumentNullException(nameof(addressee), "array is empty");
            }
        ...
        public static string GetArrayValue(int[] indexArray, int indexArrayPosition, string[] valueArray)
        {
            ...
            {
                throw new ArgumentException(" is empty.", nameof(indexArray));
            }
            ...
            {
                throw new ArgumentException(" is empty.", nameof(valueArray));
            }

            if (indexArrayPosition < 0 || indexArrayPosition >= indexArray.Length)
            {
                throw new ArgumentOutOfRangeException(nameof(indexArrayPosition), " is out of range.");
            }
            ...
            {
                throw new ArgumentException("position is out of range.", nameof(indexArray));
            }
